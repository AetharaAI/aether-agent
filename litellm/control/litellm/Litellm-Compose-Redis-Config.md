## This is litellm's docker-compose.yml & config.yaml
...
services:
  litellm:
    ...
    env_file:
      - .env
    ports:
      - "4000:4000"        # ONLY THING EXPOSED TO THE INTERNET
    volumes:
...
model_list:
 ...
 # =========================
  ...
  # =========================
  # AetherPro.tech LiteLLM Models
  # =========================

  - model_name: qwen3-vl-local
    litellm_params:
      model: qwen3-vl-30b-instruct-awq-a3-4bit
